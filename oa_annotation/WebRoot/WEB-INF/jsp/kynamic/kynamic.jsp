...
<DIV ID="addVersion" STYLE="margin-left: 3px; width: 700px; float: left;" border="3">
  ...
  <tr>
    <td colspan="2" bgcolor="#F0F7FD" height="50"><table width="199" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="100"><input name="" id="checkin" type="button" value="check in" style="background: #D3EDFC;border:1px solid  #91C0E3; cursor:pointer;"/></td>
        <td width="99"><input name="" id="checkout" type="button" value="check out" style="background: #D3EDFC;border:1px solid  #91C0E3; cursor:pointer;"/></td>
      </tr>
    </table></td>
    </tr>
</table>
...
<DIV ID="versionList" STYLE="margin-left: 3px; width: 700px; float: left; display:none;" border="2">
  ...
  <tr>
    <td height="30"><table width="700" height="26" border="0" cellpadding="0" cellspacing="0" style="background: url(css/images/411.jpg) repeat-x;">
      <tr>
...
<div class="addnodes" id="rMenu" style="position:absolute;display:none;overflow:hidden">
       <ul>
         ...
         <li id="deleteNode" style="background: url(css/images/jian.jpg) 10px 9px no-repeat;border-bottom:1px solid #8ab2e6;overflow:hidden;cursor:pointer">删除节点</li>
         <li id="updateNode" style="background: url(css/images/jian.jpg) 10px 9px no-repeat;border-bottom:1px solid #8ab2e6;overflow:hidden;cursor:pointer">修改节点</li>
       </ul>
    </div>
</BODY>
</HTML>
