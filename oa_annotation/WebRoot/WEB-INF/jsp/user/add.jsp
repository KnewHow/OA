...
<script language="javascript" src="${pageContext.request.contextPath}/js/user-add.js"></script>
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr><td width="100">所属部门</td>
                        <td>
                        	<s:select list="#departments" name="did" listKey="did" listValue="dname" headerKey="" headerValue="请选择部门" cssClass="SelectStyle"></s:select>
                        </td>
                    </tr>
                    <tr><td>用户名</td>
                        <td>
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
						<td width="100">岗位</td>
                        <td><s:select list="#posts" name="pids" listKey="pid" listValue="pname" headerKey="" headerValue="请选择岗位" cssClass="SelectStyle" multiple="true" size="10" ></s:select>
                            按住Ctrl键可以多选或取消选择
                        </td>
                    </tr>
                </table>
