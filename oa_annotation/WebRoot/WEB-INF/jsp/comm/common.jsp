...
<script language="javascript" src="${pageContext.request.contextPath}/js/jquery-config.js"></script>
<script language="javascript" src="${pageContext.request.contextPath}/js/jquery-selectAll.js"></script>
